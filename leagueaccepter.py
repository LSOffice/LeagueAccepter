...
if not "League of Legends" in names: 
    win32api.MessageBox(0, 'League of Legends is not open.', 'Error!', 0x00001000) 
    exit()
connector = Connector()
        ...
        if currentphase == 'Lobby' or currentphase == 'Matchmaking':
            ...
            while True:
                ...
                if currentphase == "Lobby":
                    print("You seem to have a queue dodge timer. This script will work after your queue dodge timer has been served")
                    time.sleep(60)
                    break
